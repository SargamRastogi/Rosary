  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 
    ...
    <div class="text-center sm:text-left">
      ...
      <ul class="space-y-2 text-neutral-400 text-sm">
        ...
        <li><a href="{{ route('residential') }}" class="hover:text-white">Residential</a></li>
        <li><a href="{{ route('commercial') }}" class="hover:text-white">Commercial</a></li>
    ...
    <div class="text-center sm:text-left">
      ...
      <ul class="space-y-2 text-neutral-400 text-sm">
        <li><a href="{{ route('projects.factories') }}" class="hover:text-white">Factories</a></li>
        <li><a href="{{ route('projects.workspace') }}" class="hover:text-white">Workspace</a></li>
        <li><a href="{{ route('projects.showroom') }}" class="hover:text-white">Showrooms</a></li>
        <li><a href="{{ route('projects.homes') }}" class="hover:text-white">Homes</a></li>
      </ul>
    </div>
