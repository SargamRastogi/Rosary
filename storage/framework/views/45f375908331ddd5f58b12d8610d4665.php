                ...
                <div class="relative z-10 flex items-center justify-center h-full text-center text-white">
                    <div>
                        ...
                        <div class="flex justify-center gap-4">
                            <a href="<?php echo e(route('residential')); ?>" class="bg-brand-gold text-white px-6 py-3 rounded-lg hover:bg-[#b89458]">Explore Projects</a>
                            <a href="<?php echo e(route('contact')); ?>" class="bg-white text-brand-gold px-6 py-3 rounded-lg hover:bg-brand-light">Book a Consultation</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="swiper-slide relative h-full bg-cover bg-center"
                ...
                <div class="relative z-10 flex items-center justify-center h-full text-center text-white">
                    <div>
                        ...
                        <div class="flex justify-center gap-4">
                            <a href="<?php echo e(route('commercial')); ?>" class="bg-brand-gold text-white px-6 py-3 rounded-lg hover:bg-[#b89458]">See Portfolio</a>
                            <a href="<?php echo e(route('contact')); ?>" class="bg-white text-brand-gold px-6 py-3 rounded-lg hover:bg-brand-light">Consult Now</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="bg-brand-light py-16">
  <div class="max-w-7xl mx-auto px-6 text-center">
    ...
    <div class="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3">
      <a href="<?php echo e(route('commercial')); ?>" class="block group">  
      <img 
    ...
    <!-- Card 2 -->
    <div class="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3">
      <a href="<?php echo e(route('residential')); ?>" class="block group"> 
        <img 
    ...
    <!-- Card 3 -->
    <div class="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3">
      <a href="<?php echo e(route('retail')); ?>" class="block group"> 
        <img 
...
<section class="py-12 bg-[#f9f7f4]">
    ...
    <div class="max-w-7xl mx-auto p-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <!-- Factories -->
            <a href="<?php echo e(route('projects.factories')); ?>" class="lg:col-span-2 h-72 overflow-hidden relative group border border-black/20 block">
            ...
            <!-- Workspace -->
            <a href="<?php echo e(route('projects.workspace')); ?>" class="h-72 overflow-hidden relative group border border-black/20 block">
            ...
            <!-- Apartments -->
            <a href="<?php echo e(route('projects.apartments')); ?>" class="h-72 overflow-hidden relative group border border-black/20 block">
            ...
            <!-- Homes -->
            <a href="<?php echo e(route('projects.homes')); ?>" class="lg:col-span-2 h-72 overflow-hidden relative group border border-black/20 block">
            ...
            <!-- Showrooms -->
            <a href="<?php echo e(route('projects.showroom')); ?>" class="lg:col-span-2 h-72  overflow-hidden relative group border border-black/20 block">
...
<?php if (isset($component)) { $__componentOriginal43f427672e87f2c2604676adad064e72 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal43f427672e87f2c2604676adad064e72 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.best-seller-products','data' => ['subcategories' => $subcategories,'products' => $products]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('best-seller-products'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['subcategories' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($subcategories),'products' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($products)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal43f427672e87f2c2604676adad064e72)): ?>
<?php $attributes = $__attributesOriginal43f427672e87f2c2604676adad064e72; ?>
<?php unset($__attributesOriginal43f427672e87f2c2604676adad064e72); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal43f427672e87f2c2604676adad064e72)): ?>
<?php $component = $__componentOriginal43f427672e87f2c2604676adad064e72; ?>
<?php unset($__componentOriginal43f427672e87f2c2604676adad064e72); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\rosary\resources\views/home.blade.php ENDPATH**/ ?>