...
<head>
  ...
  <title><?php echo e(config('app.name', 'Civil Interior Projects')); ?></title>
...
<nav class="hidden lg:flex items-center gap-8 font-semibold text-sm tracking-wide text-neutral-800">
  ...
  <div class="relative group">
    <a href="<?php echo e(route('residential')); ?>"
  ...
  <!-- Commercial -->
  <div class="relative group">
    <a href="<?php echo e(route('commercial')); ?>"
       class="hover:text-[#c7a45d] transition flex items-center gap-1">
      Commercial 
      <i class="fa-solid fa-chevron-down text-[10px]"></i>
    </a>
  ...
  <!-- Retail -->
  <div class="relative group">
    <a href="<?php echo e(route('retail')); ?>"
       class="hover:text-[#c7a45d] transition flex items-center gap-1">
      Retail 
      <i class="fa-solid fa-chevron-down text-[10px]"></i>
    </a>
  ...
  <!-- Contact -->
  <a href="<?php echo e(route('contact')); ?>" class="hover:text-[#c7a45d] transition">
    Contact
  </a>
    ...
    <div class="hidden lg:flex items-center gap-6">
      ...
      <div class="flex items-center gap-8 text-neutral-700 text-xs font-medium">
        ...
        <!-- Bag -->
        <a href="<?php echo e(route('cart.index')); ?>" class="flex flex-col items-center relative hover:text-[#c7a45d] transition">
        ...
        <div class="flex-1 overflow-y-auto px-6 py-6 space-y-6 text-base font-medium text-neutral-800">
            ...
            <div x-data="{ open:false }" class="space-y-2">
                <div class="flex justify-between items-center">
                    <a href="<?php echo e(route('residential')); ?>" class="hover:text-[#c7a45d] transition">
                        Residential
                    </a>
            ...
            <div x-data="{ open:false }" class="space-y-2">
                <div class="flex justify-between items-center">
                    <a href="<?php echo e(route('commercial')); ?>" class="hover:text-[#c7a45d] transition">
                        Commercial
                    </a>
                    <button @click="open = !open" type="button">
                        <i class="fa-solid fa-chevron-down text-xs transition"
            ...
            <div x-data="{ open:false }" class="space-y-2">
                <div class="flex justify-between items-center">
                    <a href="<?php echo e(route('retail')); ?>" class="hover:text-[#c7a45d] transition">
                        Retail
                    </a>
                    <button @click="open = !open" type="button">
                        <i class="fa-solid fa-chevron-down text-xs transition"
            ...
            <a href="<?php echo e(route('contact')); ?>" class="block hover:text-[#c7a45d] transition">
                Contact
            </a>
...
</html><?php /**PATH E:\rosary\resources\views/layouts/app.blade.php ENDPATH**/ ?>